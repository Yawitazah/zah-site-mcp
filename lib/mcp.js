...
function buildServer(site) {
  ...
  server.registerTool('get_site', {
    ...
    how: 'Call list_content(page) to see every editable element with a key. Change words with set_text, buttons and links with set_link, pictures with set_image. Edits go live for every visitor immediately. history and revert undo anything.',
  }));
